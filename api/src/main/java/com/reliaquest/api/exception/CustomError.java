...
public enum CustomError {
    ...
    MISSING_OR_INVALID_NAME("E4", "Name is either invalid or empty"),
    EMPLOYEE_NOT_FOUND_BY_NAME("E5", "Employee not found with the specified name"),
    MISSING_OR_INVALID_SALARY("E6", "Salary either invalid or empty"),
    NEGATIVE_SALARY_NOT_ALLOWED("E7", "Salary cannot be a negative value"),
    MISSING_OR_INVALID_TITLE("E8", "Title is either invalid or empty"),
    MISSING_OR_INVALID_AGE("E9", "Age is either invalid or empty"),
